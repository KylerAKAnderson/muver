...
setup(
    ...
    maintainer_email='kyler.anderson@nih.gov',
    url='https://github.com/niehs/muver',
    packages=find_packages(include=['muver', 'muver.wrappers', 'muver.depth']),
    entry_points={
        'console_scripts': [
    ...
    data_files=[('config', ['paths.cfg']), ('nusfd',['shoulder_parameters.txt'])],
)
